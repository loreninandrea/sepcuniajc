...
<footer class="main-footer">
    ...
    <strong>Control de ejecución de programa.</strong>
</footer>
...
<!-- FastClick -->
<script src="<?php echo base_url() ?>template/plugins/x-editable/bootstrap3-editable/js/bootstrap-editable.min.js"></script>
<script src="<?php echo base_url() ?>template/plugins/fastclick/fastclick.js"></script>
<script src="<?php echo base_url() ?>template/plugins/moment.js"></script>
<!-- AdminLTE App -->
...
<script src="<?php echo base_url() ?>template/plugins/control.js"></script>
